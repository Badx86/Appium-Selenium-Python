...
class BasePage:
    ...
    def launchWebPage(self, url, title):
        try:
            ...
            self.log.error('Web Page is not Launched wth URL: ' + url)
    ...
    def getWebElement(self, locatorValue, locatorType='id'):
        ...
        try:
            ...
            self.log.info(
                'WebElement found with locatorValue: ' + locatorValue + ' using locatorType: ' + locatorByType)
        except:
            self.log.error(
                'WebElement is not found with locatorValue: ' + locatorValue + ' using locatorType: ' + locatorType)
            print_stack()
        return webElement
    ...
    def clickOnElement(self, locatorValue, locatorType="id"):
        try:
            ...
            self.log.error("Unable to Click on WebElement with locator value: " + locatorValue
                           + " using locatorType: " + locatorType)
            print_stack()
            assert False
    ...
    def sendText(self, text, locatorValue, locatorType="id"):
        try:
            ...
            self.log.info("Sent the text: " + text + " in WebElement with locator value: " + locatorValue
                          + " using locatorType: " + locatorType)
        except:
            self.log.error(
                "Unable to Sent the text: " + text + " in WebElement with locator value: " + locatorValue
                + "using locatorType: " + locatorType)
            print_stack()
            self.takeScreenshot(locatorType)
            assert False
    ...
    def getText(self, locatorValue, locatorType="id"):
        ...
        try:
            ...
            self.log.info("Get the text: " + elementText + " from WebElement with locator value: " + locatorValue
                          + " using locatorType: " + locatorType)
        except:
            self.log.error(
                "Unable to get the text: " + elementText + " from WebElement with locator value: " + locatorValue
                + "using locatorType: " + locatorType)
            print_stack()
    ...
    def isElementDisplayed(self, locatorValue, locatorType="id"):
        ...
        try:
            ...
            self.log.info("WebElement is Displayed on web page with locator value " + locatorValue
                          + " using locatorType " + locatorType)
        except:
            self.log.error(
                "WebElement is not Displayed on web page with locator value " + locatorValue
                + " using locatorType " + locatorType)
            print_stack()
